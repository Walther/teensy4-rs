#[doc = "Reader of register BITER_ELINKNO"]
pub type R = crate::R<u16, super::BITER_ELINKNO>;
#[doc = "Writer for register BITER_ELINKNO"]
pub type W = crate::W<u16, super::BITER_ELINKNO>;
#[doc = "Register BITER_ELINKNO `reset()`'s with value 0"]
impl crate::ResetValue for super::BITER_ELINKNO {
    type Type = u16;
    #[inline(always)]
