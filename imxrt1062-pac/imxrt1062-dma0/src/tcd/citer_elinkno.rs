#[doc = "Reader of register CITER_ELINKNO"]
pub type R = crate::R<u16, super::CITER_ELINKNO>;
#[doc = "Writer for register CITER_ELINKNO"]
pub type W = crate::W<u16, super::CITER_ELINKNO>;
#[doc = "Register CITER_ELINKNO `reset()`'s with value 0"]
impl crate::ResetValue for super::CITER_ELINKNO {
    type Type = u16;
    #[inline(always)]
