#[doc = "Reader of register DLASTSGA"]
pub type R = crate::R<u32, super::DLASTSGA>;
#[doc = "Writer for register DLASTSGA"]
pub type W = crate::W<u32, super::DLASTSGA>;
#[doc = "Register DLASTSGA `reset()`'s with value 0"]
impl crate::ResetValue for super::DLASTSGA {
    type Type = u32;
    #[inline(always)]
