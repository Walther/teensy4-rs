#[doc = "Reader of register DOFF"]
pub type R = crate::R<u16, super::DOFF>;
#[doc = "Writer for register DOFF"]
pub type W = crate::W<u16, super::DOFF>;
#[doc = "Register DOFF `reset()`'s with value 0"]
impl crate::ResetValue for super::DOFF {
    type Type = u16;
    #[inline(always)]
