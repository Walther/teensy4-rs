#[doc = "Reader of register NBYTES_MLOFFNO"]
pub type R = crate::R<u32, super::NBYTES_MLOFFNO>;
#[doc = "Writer for register NBYTES_MLOFFNO"]
pub type W = crate::W<u32, super::NBYTES_MLOFFNO>;
#[doc = "Register NBYTES_MLOFFNO `reset()`'s with value 0"]
impl crate::ResetValue for super::NBYTES_MLOFFNO {
    type Type = u32;
    #[inline(always)]
