#[doc = "Reader of register NBYTES_MLOFFYES"]
pub type R = crate::R<u32, super::NBYTES_MLOFFYES>;
#[doc = "Writer for register NBYTES_MLOFFYES"]
pub type W = crate::W<u32, super::NBYTES_MLOFFYES>;
#[doc = "Register NBYTES_MLOFFYES `reset()`'s with value 0"]
impl crate::ResetValue for super::NBYTES_MLOFFYES {
    type Type = u32;
    #[inline(always)]
