#[doc = "Reader of register SLAST"]
pub type R = crate::R<u32, super::SLAST>;
#[doc = "Writer for register SLAST"]
pub type W = crate::W<u32, super::SLAST>;
#[doc = "Register SLAST `reset()`'s with value 0"]
impl crate::ResetValue for super::SLAST {
    type Type = u32;
    #[inline(always)]
