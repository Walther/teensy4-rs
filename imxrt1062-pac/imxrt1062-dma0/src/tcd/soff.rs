#[doc = "Reader of register SOFF"]
pub type R = crate::R<u16, super::SOFF>;
#[doc = "Writer for register SOFF"]
pub type W = crate::W<u16, super::SOFF>;
#[doc = "Register SOFF `reset()`'s with value 0"]
impl crate::ResetValue for super::SOFF {
    type Type = u16;
    #[inline(always)]
